# Nexus Dominion - Quick Start Guide
...
|----------|--------------|
| **Credits** | Buy everything |
| **Food** | Feed population (CRITICAL) |
| **Ore** | Build ships |
| **Petroleum** | Power advanced units |
| **Research** | Unlock technology |

> **IMPORTANT:** If Food < Population, your people starve and your empire collapses!
...
**Diversity Bonus:** 4+ unit types = +15% combat power
...
| Watch Out For | Safe To Ignore |
|---------------|----------------|
| Warlord | Diplomat |
| Blitzkrieg | Turtle |
| Opportunist | Merchant |
...
- Full guide: [HOW-TO-PLAY.md](./HOW-TO-PLAY.md)
- Game start: [localhost:3000/game](http://localhost:3000/game)
